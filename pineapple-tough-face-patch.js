window.__patchPvZRoguePineappleToughFace = function patchPvZRoguePineappleToughFace(source) {
  const from = `      <path d="M20 31 Q27 25 33 30" stroke="#553319" strokeWidth="2.7" fill="none" strokeLinecap="round"/><ellipse cx="27" cy="33" rx="2.3" ry="3.4" fill="#25180f"/>
      <path d="M31 47 C36 50 40 49 44 45" stroke="#59351b" strokeWidth="2.4" fill="none" strokeLinecap="round"/>`;
  const to = `      {/* battered boxer face */}
  ...
  if (!source.includes(from)) throw new Error('Pineapple tough-face patch could not find the original face.');
